                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="file" name="file" class="form-control file-upload-info" require>
                                     <label for="exampleInputEmail2" class="col-sm-12 col-form-label">{{ $post->gallery_id }}</label> 
                                    <img src="{{ asset('/storage/images/posts/thumbnail').'/'. $post->gallery_id }}" alt="images" width="150px">
                                </div>
